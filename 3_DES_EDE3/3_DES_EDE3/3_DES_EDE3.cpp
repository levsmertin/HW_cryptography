...
public:
	...
	std::string Keygen(char &cipher_mode)
	{
		...
		byte new_key[CryptoPP::DES_EDE3::DEFAULT_KEYLENGTH];
		...
		if (cipher_mode != '0')
		{
			...
			byte new_iv[CryptoPP::DES_EDE3::BLOCKSIZE];
	...
	std::string Encrypt(char &cipher_mode)
	{
		...
		if (!rez) return "OPEN_FILE_ERROR\n";
		if (!(cipher_mode > '5' || cipher_mode < '1') && (key.GetData().size() != CryptoPP::DES_EDE3::DEFAULT_KEYLENGTH + CryptoPP::DES_EDE3::BLOCKSIZE)) return "KEY_SIZE_ERROR\n";
		if (cipher_mode == '0' && key.GetData().size() != CryptoPP::DES_EDE3::DEFAULT_KEYLENGTH) return "KEY_SIZE_ERROR\n";

		byte file_key[CryptoPP::DES_EDE3::DEFAULT_KEYLENGTH];
		byte file_iv[CryptoPP::DES_EDE3::BLOCKSIZE];
		int i = 0;

		for (; i < CryptoPP::DES_EDE3::DEFAULT_KEYLENGTH; i++)
		{
			file_key[i] = key.GetData().at(i);
		}
		if (cipher_mode != '0')
		{
			for (int j = 0; i < CryptoPP::DES_EDE3::DEFAULT_KEYLENGTH + CryptoPP::DES_EDE3::BLOCKSIZE; i++)
			{
		...
		{
					CryptoPP::ECB_Mode<CryptoPP::DES_EDE3>::Encryption E(file_key, sizeof (file_key));
		...
		{
					CryptoPP::CBC_Mode<CryptoPP::DES_EDE3>::Encryption E(file_key, sizeof (file_key), file_iv);
					CryptoPP::ArraySource(plaintext.GetData().data(), plaintext.GetData().size(), true, new CryptoPP::StreamTransformationFilter(E, new CryptoPP::Redirector(cs)));
					break;
		}
		case '2':
		{
					CryptoPP::CFB_Mode<CryptoPP::DES_EDE3>::Encryption E(file_key, sizeof (file_key), file_iv);
					CryptoPP::ArraySource(plaintext.GetData().data(), plaintext.GetData().size(), true, new CryptoPP::StreamTransformationFilter(E, new CryptoPP::Redirector(cs)));
					break;
		}
		case '3':
		{
					CryptoPP::OFB_Mode<CryptoPP::DES_EDE3>::Encryption E(file_key, sizeof (file_key), file_iv);
					CryptoPP::ArraySource(plaintext.GetData().data(), plaintext.GetData().size(), true, new CryptoPP::StreamTransformationFilter(E, new CryptoPP::Redirector(cs)));
					break;
		}
		case '4':
		{
					CryptoPP::CTR_Mode<CryptoPP::DES_EDE3>::Encryption E(file_key, sizeof (file_key), file_iv);
					CryptoPP::ArraySource(plaintext.GetData().data(), plaintext.GetData().size(), true, new CryptoPP::StreamTransformationFilter(E, new CryptoPP::Redirector(cs)));
					break;
		}
		default:
	...
	std::string Decrypt(char &cipher_mode)
	{
		...
		{
					CryptoPP::ECB_Mode<CryptoPP::DES_EDE3>::Decryption D(file_key, sizeof (file_key));
		...
		{
					CryptoPP::CBC_Mode<CryptoPP::DES_EDE3>::Decryption D(file_key, sizeof (file_key), file_iv);
					CryptoPP::ArraySource(ciphertext.GetData().data(), ciphertext.GetData().size(), true, new CryptoPP::StreamTransformationFilter(D, new CryptoPP::Redirector(ds)));
					break;
		}
		case '2':
		{
					CryptoPP::CFB_Mode<CryptoPP::DES_EDE3>::Decryption D(file_key, sizeof (file_key), file_iv);
					CryptoPP::ArraySource(ciphertext.GetData().data(), ciphertext.GetData().size(), true, new CryptoPP::StreamTransformationFilter(D, new CryptoPP::Redirector(ds)));
					break;
		}
		case '3':
		{
					CryptoPP::OFB_Mode<CryptoPP::DES_EDE3>::Decryption D(file_key, sizeof (file_key), file_iv);
					CryptoPP::ArraySource(ciphertext.GetData().data(), ciphertext.GetData().size(), true, new CryptoPP::StreamTransformationFilter(D, new CryptoPP::Redirector(ds)));
					break;
		}
		case '4':
		{
					CryptoPP::CTR_Mode<CryptoPP::DES_EDE3>::Decryption D(file_key, sizeof (file_key), file_iv);
					CryptoPP::ArraySource(ciphertext.GetData().data(), ciphertext.GetData().size(), true, new CryptoPP::StreamTransformationFilter(D, new CryptoPP::Redirector(ds)));
					break;
		}
		default:
...
int _tmain(int argc, _TCHAR* argv[])
{
	...
	do
	{
		...
		case '1':
			...
			my_DES_EDE3.Init(plaintext_file, key_file, ciphertext_file);
			std::cout << my_DES_EDE3.Encrypt(cipher_mode);
			system("pause");
			break;
		...
		case '2':
			...
			std::cin >> plaintext_file;
			my_DES_EDE3.Init(plaintext_file, key_file, ciphertext_file);
			std::cout << my_DES_EDE3.Decrypt(cipher_mode);
			system("pause");
			break;
		...
		case '3':
			...
			std::cout << "Block cipher mode of operation\n 0:ECB 1:CBC 2:CFB 3:OFB 4:CRT\n";
			std::cin >> cipher_mode;
			std::cout << my_DES_EDE3.Keygen(cipher_mode);
			system("pause");
			break;
