...
void main()
{
	std::string f_public = "..\\resources\\out\\public";
	std::string f_privat = "..\\resources\\out\\privat";
	std::string f_plain = "..\\resources\\1.docx";
	std::string f_cipher = "..\\resources\\out\\cipher";
	std::string f_decrypt = "..\\resources\\out\\decript.docx";
	bool flag;
