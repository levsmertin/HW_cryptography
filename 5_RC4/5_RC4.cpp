...
void main()
{
	std::string plaintext_file = "..\\resources\\1.docx";
	std::string key_file = "..\\resources\\key_for_rc4";
	std::string ciphertext_file = "..\\resources\\out\\cipherRC4";
	std::string decrypt_file = "..\\resources\\out\\decriptRC4.docx";
	RC4 my_RS4;
